...
THEN my default email program opens and populates the TO field of the email with the address //mailto: in html link
WHEN I click on the GitHub username
THEN that GitHub profile opens in a new tab //target _blank
